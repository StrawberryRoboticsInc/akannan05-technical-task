...
class FrankaCortex(CortexBase):
    ...
    def setup_scene(self):
        ...
        obs_specs = [ # modification is here
            CubeSpec("RedCube", [1.0, 0.0, 0.0]),
            CubeSpec("BlueCube", [1.0, 0.0, 0.0]),
            CubeSpec("YellowCube", [1.0, 0.0, 0.0]),
            CubeSpec("GreenCube", [1.0, 0.0, 0.0]),
        ]
        width = 0.1 #originally 0.0515
